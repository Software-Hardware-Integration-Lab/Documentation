...
7. You will be prompted to update your password by entering the temporary password and a new password. For more information about generating a password, see [Passwords](Break-Glass-Overview.md#passwords).
