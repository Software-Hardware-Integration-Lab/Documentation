...
!!! note "Privileged Hardware"
    For requirements and best practices on privileged hardware, please see the [Hardware Selection](../../Reference/Hardware-Selection) documentation.
...
- [Hardware Selection](../../Reference/Hardware-Selection)
- [Device Onboarding Workflow Reference](../../Reference/Diagrams/Device-Commission)
