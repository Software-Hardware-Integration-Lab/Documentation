...
- [Lifecycle Management Overview](../Usage-Guide/): Learn more about the lifecycle management features of SHIELD and how it simplifies the management of user and device objects.
- [Commissioning a New Device](../Usage-Guide/Device/0-Commission): Step-by-step guide on commissioning (adopting) a new device using SHIELD.
- [Decommission a Managed Device](../Usage-Guide/Device/1-Decommission): Step-by-step guide on decommissioning (removing) a device that is currently being managed by SHIELD.
