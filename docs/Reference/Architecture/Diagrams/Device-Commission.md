...
PrivCaOemCheck[Check if the requested OEM in in the Conditional Acces Hardware Allowed List]
PrivCaModelCheck[Check if the requested Model in in the Conditional Acces Hardware Allowed List]
